...
{
    public class SocialLeaderboardDataRequest : GameSparksBaseRequest
    {
        [JsonProperty("@class")]
        ...
        /// <summary>
        /// Initialize a new SocialLeaderboardDataRequest
        /// </summary>
        ...
        public SocialLeaderboardDataRequest(string challengeInstanceId, bool dontErrorOnNotSocial, int entryCount, List<string> friendIds, int includeFirst, int includeLast, bool inverseSocial, string leaderboardShortCode, int offset, string playerId, bool social, List<string> teamIds, List<string> teamTypes, string requestId = "")
        {
